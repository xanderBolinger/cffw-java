...
public class VehicleOddsOfHittingTable {
	// Singleton instance
    private static VehicleOddsOfHittingTable instance;

    // 2D array list for range and odds of hitting
    private ArrayList<ArrayList<Integer>> rangeOddsList;

    // Private constructor for singleton
    private VehicleOddsOfHittingTable() {
        initializeData();
    }

    // Method to get the singleton instance
    public static VehicleOddsOfHittingTable getInstance() {
        if (instance == null) {
            instance = new VehicleOddsOfHittingTable();
        }
        return instance;
    }
    ...
    public static void main(String[] args) {
        ...
        int oddsForRange = VehicleOddsOfHittingTable.getOddsOfHitting(20);
