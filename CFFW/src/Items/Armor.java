...
public class Armor implements Serializable {
	...
	public enum ArmorType {
		...
		EasternRegular6b43,EasternConscript6B3,
		WesternIOTV,WesterPlateCarrier,WesternLightPlateCarrier
	...
	public Armor(ArmorType type) {
		...
		if(type == ArmorType.PHASEONE) {
			...
			mkviiiErrant();
		} else if(type == ArmorType.EasternRegular6b43){
			easternRegular6b43();
		} else if(type == ArmorType.EasternConscript6B3){
			easternConscript6B3();
		} else if(type == ArmorType.WesternIOTV){
			westernIOTV();
		} else if(type == ArmorType.WesterPlateCarrier){
			westernPlaterCarier();
		} else if(type == ArmorType.WesternLightPlateCarrier){
			westernPlaterCarierLight();
		} else {
			armorName = "None";
			type = ArmorType.NONE;
		}
	...
	public void westernPlaterCarierLight() {
		if(MeleeArmor.meleeArmorPieces == null)
			new MeleeArmorData();
		this.bPF = 20; 
		armorName = "Plate Carrier(w/o Sides) + Enhanced Helmet";
		type = ArmorType.WesternLightPlateCarrier;
		this.armorWeight = 18;
		...
		differingZonePF.add(6);
		differingHardnessZone.add(false);
		
		try {
			meleeArmorStats.add(MeleeArmor.getArmorPiece(MeleeArmorType.Curiass));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void westernPlaterCarier() {
		if(MeleeArmor.meleeArmorPieces == null)
			new MeleeArmorData();
		this.bPF = 20; 
		armorName = "Plate Carrier(w/Sides) + Enhanced Helmet";
		type = ArmorType.WesterPlateCarrier;
		this.armorWeight = 25;
	...
	public void westernIOTV() {
		if(MeleeArmor.meleeArmorPieces == null)
			new MeleeArmorData();
		this.bPF = 20; 
		armorName = "IOTV + Enhanced Helmet";
		type = ArmorType.WesternIOTV;
		this.armorWeight = 34;
	...
	public void easternConscript6B3() {
		if(MeleeArmor.meleeArmorPieces == null)
			new MeleeArmorData();
		this.bPF = 10; 
		armorName = "6B3 + Helemt";
		type = ArmorType.EasternConscript6B3;
	...
	public void easternRegular6b43() {
		if(MeleeArmor.meleeArmorPieces == null)
			new MeleeArmorData();
		this.bPF = 20; 
		armorName = "6B43 + Helemt";
		type = ArmorType.EasternRegular6b43;
		this.armorWeight = 31;
