...
public class Weapons implements Serializable {
	...
	// Weapon bonus equals GURPS accuracy x 5, increased five or 10 for rapid fire if applicable, +5% for every 2x magnification 
	// Targeted ROF is base 10, modified by weapon bulk, suppressive fire is 10 + ROF / 3 (to get the effective burst) and multiplied by 5. 
	// Most of these weapons do not have GURPS stats but they have a stat block that is their insperation 
	...
	public void DC40() {
		...
		/*Ammo heat = new Ammo("HEAT", 8, 0, 6, 10, null, null, null);
		Ammo he = new Ammo("HE", 8, 0, 4, 10, null, null, null);*/
		
		ammoTypes = new ArrayList<Ammo>();
		/*this.ammoTypes.add(heat);
		this.ammoTypes.add(he);*/
	...
	public ArrayList<Weapons> getWeaponsFromType(String type) {
		...
		for(Weapons wep : this.weapons) {
			...
			if(type.equals("Small Arms") && (wepType.equals("Pistol")
					|| wepType.equals("Subgun")
					|| wepType.equals("Rifle")
					|| wepType.equals("Heavy")))
				weapons.add(wep);
			
			if(type.equals("Heavy Weapons") && 
					(wepType.equals("Static")
					|| wepType.equals("Cannon")))
				weapons.add(wep);
	...
	public String toString() {
		String wep = name + "; " + type + "; " + targetROF + ":" + suppressiveROF+"; DMG: "+damage+"; AP: "+armorPiercing;
		return wep;
	}
}
