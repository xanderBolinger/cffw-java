...
public class CeHexGrid extends JPanel {
	...
	public CeHexGrid(int hexRows, int hexCols) {
		...
		// Images/"+GameWindow.gameWindow.game.mapImageFileName));
		/*
		 * backgroundImageWidth = (int) (s * (columns / 2 * 3)); backgroundImageHeight =
		 * (int) (s * 1.7175 * rows); backgroundImageHeight -= backgroundImageHeight /
		 * rows / 2; backgroundImage =
		 * originalImage.getScaledInstance(backgroundImageWidth, backgroundImageHeight,
		 * Image.SCALE_SMOOTH);
		 */
	...
	public void makeHexes(int rows, int columns) {
		...
		for (int i = 1; i <= rows; i++) {
			...
			for (int j = 1; j <= columns; j++) {
				...
				/*
				 * drawnStrings.add(new DrawnString(i + ":" + j, new Point((int) (cordX + j *
				 * ((3 * s) / 2)), (int) (cordY + (j % 2) * a + 2 * i * a))));
				 */
			}
	...
	public void paintComponent(Graphics g) {
		...
		// System.out.println("shapeList: "+shapeList.size()+", Deployed Units:
		// "+deployedUnits.size());
		...
		/*
		 * shadeHex(g2, hexMap.get(0).get(1)); shadeHex(g2, hexMap.get(0).get(2));
		 * shadeHex(g2, hexMap.get(0).get(3)); shadeHex(g2, hexMap.get(0).get(4));
		 */

		/*
		 * shadeHex(g2, hexMap.get(1).get(0)); shadeHex(g2, hexMap.get(2).get(0));
		 * shadeHex(g2, hexMap.get(3).get(0)); shadeHex(g2, hexMap.get(4).get(0));
		 * shadeHex(g2, hexMap.get(5).get(0));
		 * 
		 * shadeHex(g2, hexMap.get(6).get(0)); shadeHex(g2, hexMap.get(7).get(0));
		 * shadeHex(g2, hexMap.get(8).get(0)); shadeHex(g2, hexMap.get(9).get(0));
		 * shadeHex(g2, hexMap.get(10).get(0)); shadeHex(g2, hexMap.get(11).get(0));
		 * shadeHex(g2, hexMap.get(12).get(0));
		 */

		/*
		 * drawChevron(g2, Facing.A, hexMap.get(0).get(1)); drawChevron(g2, Facing.D,
		 * hexMap.get(0).get(2)); drawChevron(g2, Facing.AB, hexMap.get(0).get(3));
		 * drawChevron(g2, Facing.B, hexMap.get(0).get(4));
		 */

		/*
		 * drawChevron(g2, hexMap.get(1).get(0), Facing.A); drawChevron(g2,
		 * hexMap.get(2).get(0), Facing.AB); drawChevron(g2, hexMap.get(3).get(0),
		 * Facing.B); drawChevron(g2, hexMap.get(4).get(0), Facing.BC); drawChevron(g2,
		 * hexMap.get(5).get(0), Facing.C);
		 * 
		 * drawChevron(g2, hexMap.get(6).get(0), Facing.CD); drawChevron(g2,
		 * hexMap.get(7).get(0), Facing.D); drawChevron(g2, hexMap.get(8).get(0),
		 * Facing.DE); drawChevron(g2, hexMap.get(9).get(0), Facing.E); drawChevron(g2,
		 * hexMap.get(10).get(0), Facing.EF); drawChevron(g2, hexMap.get(11).get(0),
		 * Facing.F); drawChevron(g2, hexMap.get(12).get(0), Facing.FA);
		 */
		...
		if (pressedCursorPoint != null && currentCursorPoint != null && dragging
			 ...
			 * backgroundImageHeight, 1); backgroundImageX = shapeList.get(0).getBounds().x
			 * + 11; backgroundImageY = shapeList.get(0).getBounds().y;
			 */
