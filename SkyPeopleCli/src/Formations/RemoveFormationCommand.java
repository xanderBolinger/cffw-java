...
public class RemoveFormationCommand implements Command {

	String formationName; 
	Ship ship;
	
	public RemoveFormationCommand(ArrayList<String> parameters) {
		...
		for(Formation formation : GameMaster.game.formations) {
			if(formation.formationName.equals(formationName)) {
				if(!formation.ships.contains(ship)) {
					System.out.println("Ship not in formation.");
					return;
				}
