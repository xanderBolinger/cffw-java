...
public class HardPointTests {
	...
	public void venatorHardPointTests() {
		...
		assertEquals(1, venator.hardPoints.get(1).fireArcIndex);
		assertEquals(WeaponType.MEDIUM_TURBO_LASER, venator.hardPoints.get(2).weapons.get(0).weaponType);
		assertEquals(2, venator.hardPoints.get(2).fireArcIndex);
		assertEquals(WeaponType.MEDIUM_TURBO_LASER, venator.hardPoints.get(3).weapons.get(0).weaponType);
		assertEquals(2, venator.hardPoints.get(3).fireArcIndex);
	}
