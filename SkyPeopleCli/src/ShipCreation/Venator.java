...
public class Venator implements ShipTemplate {
	...
	public void hitTable() {
		...
		nose.add(new HitLocation(ComponentType.BRIDGE, 5));
		...
		nose.add(new HitLocation(ComponentType.BATTERY, 8));
		nose.add(new HitLocation(ComponentType.POINTDEFENSE, 5));
		
		ArrayList<HitLocation> aft = new ArrayList<HitLocation>();
		aft.add(new HitLocation(ComponentType.HYPERDRIVE, 4));
		aft.add(new HitLocation(ComponentType.HYPERDRIVE, 4));
		aft.add(new HitLocation(ComponentType.THRUST, 4));
		aft.add(new HitLocation(ComponentType.THRUST, 4));
		aft.add(new HitLocation(ComponentType.THRUST, 4));
		aft.add(new HitLocation(ComponentType.HEATSINKS, 4));
		aft.add(new HitLocation(ComponentType.HEATSINKS, 4));
		aft.add(new HitLocation(LocationType.FUEL, 4));
		aft.add(new HitLocation(LocationType.FUEL, 4));
		aft.add(new HitLocation(ComponentType.POINTDEFENSE, 4));
		
		ArrayList<HitLocation> port = new ArrayList<HitLocation>();
		port.add(new HitLocation(0, 4));
		port.add(new HitLocation(3, 4));
		port.add(new HitLocation(ComponentType.QUARTERS, 6));
		port.add(new HitLocation(ComponentType.CARGO, 6));
		port.add(new HitLocation(ComponentType.CARGO, 6));
		port.add(new HitLocation(ComponentType.REACTORS, 6));
		port.add(new HitLocation(ComponentType.BATTERY, 6));
		port.add(new HitLocation(ComponentType.BATTERY, 6));
		port.add(new HitLocation(LocationType.FUEL, 6));
		port.add(new HitLocation(ComponentType.POINTDEFENSE, 4));
		
		ArrayList<HitLocation> starboard = new ArrayList<HitLocation>();
		starboard.add(new HitLocation(1, 4));
		starboard.add(new HitLocation(4, 4));
		starboard.add(new HitLocation(ComponentType.QUARTERS, 6));
		starboard.add(new HitLocation(ComponentType.CARGO, 6));
		starboard.add(new HitLocation(ComponentType.CARGO, 6));
		starboard.add(new HitLocation(ComponentType.REACTORS, 6));
		starboard.add(new HitLocation(ComponentType.BATTERY, 6));
		starboard.add(new HitLocation(ComponentType.BATTERY, 6));
		starboard.add(new HitLocation(LocationType.FUEL, 6));
		starboard.add(new HitLocation(ComponentType.POINTDEFENSE, 6));
		
		
		ArrayList<HitLocation> top = new ArrayList<HitLocation>();
		top.add(new HitLocation(0, 4));
		top.add(new HitLocation(1, 4));
		top.add(new HitLocation(ComponentType.BRIDGE, 6));
		top.add(new HitLocation(ComponentType.HEATSINKS, 6));
		top.add(new HitLocation(ComponentType.HANGARBAY, 8));
		top.add(new HitLocation(ComponentType.HANGARBAY, 8));
		top.add(new HitLocation(ComponentType.SHIELD, 4));
		top.add(new HitLocation(ComponentType.RADIATORS, 6));
		top.add(new HitLocation(LocationType.FUEL, 6));
		top.add(new HitLocation(ComponentType.POINTDEFENSE, 4));
		
		ArrayList<HitLocation> bottom = new ArrayList<HitLocation>();
		bottom.add(new HitLocation(ComponentType.HYPERDRIVE, 4));
		bottom.add(new HitLocation(ComponentType.THRUST, 4));
		bottom.add(new HitLocation(ComponentType.BRIDGE, 4));
		bottom.add(new HitLocation(ComponentType.HEATSINKS, 4));
		bottom.add(new HitLocation(ComponentType.REACTORS, 4));
		bottom.add(new HitLocation(LocationType.FUEL, 4));
		bottom.add(new HitLocation(LocationType.FUEL, 4));
		bottom.add(new HitLocation(LocationType.FUEL, 4));
		bottom.add(new HitLocation(LocationType.FUEL, 4));
		bottom.add(new HitLocation(ComponentType.POINTDEFENSE, 4));
		
		ArrayList<HitLocation> core = new ArrayList<HitLocation>();
		core.add(new HitLocation(ComponentType.HYPERDRIVE, 3));
		core.add(new HitLocation(ComponentType.REACTORS, 3));
		core.add(new HitLocation(ComponentType.LIFESUPPORT, 3));
		core.add(new HitLocation(ComponentType.BRIDGE, 3));
		core.add(new HitLocation(ComponentType.QUARTERS, 3));
		core.add(new HitLocation(ComponentType.HYPERDRIVE, 3));
		core.add(new HitLocation(ComponentType.VEHICLEBAY, 3));
		core.add(new HitLocation(ComponentType.BATTERY, 3));
		core.add(new HitLocation(LocationType.ELECTRONICS, 3));
		core.add(new HitLocation(ComponentType.SI, 3));
	...
	public void electronics() {
		...
		cells.add(new ElectronicCell(200, 3, 3, ElectronicType.SENSORS));
		cells.add(new ElectronicCell(0, 6, 6, ElectronicType.SENSORS));
